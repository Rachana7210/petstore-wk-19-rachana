...
public class MyStepdefs {
    ...
    static String username = "Simran" + TestUtils.getRandomString();
    static String firstname = "Saani" + TestUtils.getRandomString();
    static String lastname = "Patel" + TestUtils.getRandomString();
    static String email = "Saani" + TestUtils.getRandomNumber() + "@gmail.com";
